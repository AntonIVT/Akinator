...
//!
//! @note    Вы можете настраивать синтез речи, используя язык разметки SSML (Speech Synthesis Markup Language).
...
//!
//!              txSpeak ("\vДобрый вечер, котики. Все вы мыши. Goog evening, kittens. You are all mices.");
//!
